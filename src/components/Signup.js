...
const Signup = (props) => {
  ...
  const handleSubmit = async (e) => {
    ...
    const response = await fetch("https://inotebook-backend-theta.vercel.app:80/api/auth/createuser", {
      method: 'POST',
      headers: {
    ...
    <div className='container'>
      <form onSubmit={handleSubmit}>
        <div className="mb-3">
          ...
          <input type="text" value={credentials.name} className="form-control" id="name" name='name' onChange={onChange} />
        </div>
        <div class="mb-3">
